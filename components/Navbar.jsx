         ...
         <div className="fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden">
          ...
          <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-purple-200 bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20" : ""}`}>
            ...
            <div className="flex items-center gap-4">
                ...
                <a 
                 href="#contact"
                 className="border border-gray-400 rounded-full lg:flex items-center gap-3 px-10 py-2.5 ml-4 hidden font-Ovo dark:border-white/50" >Contact <Image src={ isDarkMode ? assets.arrow_icon_dark : assets.arrow_icon} alt="" className="w-3"/> </a>
            ...
            <ul ref={sideMenuRef} className="flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-purple-400 transition duration-500 dark:bg-darkHover dark.text-white">
