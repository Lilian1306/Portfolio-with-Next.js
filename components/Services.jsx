    ...
    <motion.div 
      ...
      id="services" className="w-full px-[12%] py-10 scroll-m-20" >
        ...
        <motion.p 
          ...
          className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo"> I am a frontend developer from Korea, with 10 years of experience in multiple companies like Microsoft, Testa and Apple</motion.p>
