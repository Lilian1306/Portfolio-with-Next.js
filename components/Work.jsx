...
export default function Work() {
    return (
        <div id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
            ...
            <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">Welcome to my web development porfolio! Explore a collection of projects showcasing my expretise in front-end development</p>
